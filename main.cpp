...
int main(int, char**)
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Calculator how do I get rid of this", WS_OVERLAPPEDWINDOW, 100, 100, 1, 1, nullptr, nullptr, wc.hInstance, nullptr);
    ...
    while (!done)
    {
        ...
        if (ImGui::Begin("Caculator 1337", NULL, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize)) {
            ImGui::SetWindowSize(ImVec2(450, 550));
